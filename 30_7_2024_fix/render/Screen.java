...
public class Screen extends JPanel
{
	...
	static PolygonObject[] DrawablePolygons = new PolygonObject[10000];
	static public Polygon3D[] Polygons3D = new Polygon3D[10000];
	...
	public Screen()
	{
		...
		Figures3D[NumberFigures3D] = new Terrain(-10, -10, 0, 40, 40, new Color(20, 255, 100 , 0), 2, 0.5);
		Figures3D[NumberFigures3D] = new PrismaR(0, 0, 5, 1, 1, 1, Color.gray, 1);
		
		globalLight = new Light(new double[] {0,0,10}, new double[] {0,0,0}, 100, true);
