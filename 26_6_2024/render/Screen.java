...
public class Screen extends JPanel
{
	...
	int[] newOrder;
	static public boolean outlines = true;	
	...
	public Screen()
	{
		...
		Figures3D[NumberFigures3D] = new Plane(-10, -10, 0, 20, 20, Color.green, 1);
		Figures3D[NumberFigures3D] = new PrismaR(0, 0, 5, 1, 1, 1, Color.red, 1);
		
		globalLight = new Light(new double[] {10,10,5}, new double[] {0,0,0}, 50);
	}
