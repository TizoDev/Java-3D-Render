...
public class Screen extends JPanel implements KeyListener
{
	...
	static int NumberOfPolygons = 0, NumberPolygons3D = 0;
	static PolygonObject[] DrawablePolygons = new PolygonObject[1000];
	static Polygon3D[] Polygons3D = new Polygon3D[1000];
	...
	public Screen()
	{
		addKeyListener(this);
		setFocusable(true);
/*		Polygons3D[NumberPolygons3D] = new Polygon3D(new double[]{0, 2, 2, 0}, new double[]{0, 0, 2, 2},  new double[]{0, 0, 0, 0}, Color.gray);
		Polygons3D[NumberPolygons3D] = new Polygon3D(new double[]{0, 2, 2, 0}, new double[]{0, 0, 2, 2},  new double[]{3, 3, 3, 3}, Color.gray);
		Polygons3D[NumberPolygons3D] = new Polygon3D(new double[]{0, 2, 2, 0}, new double[]{0, 0, 0, 0},  new double[]{0, 0, 3, 3}, Color.gray);
		Polygons3D[NumberPolygons3D] = new Polygon3D(new double[]{0, 2, 2, 0}, new double[]{2, 2, 2, 2},  new double[]{0, 0, 3, 3}, Color.gray);
		Polygons3D[NumberPolygons3D] = new Polygon3D(new double[]{0, 0, 0, 0}, new double[]{0, 2, 2, 0},  new double[]{0, 0, 3, 3}, Color.gray);
		Polygons3D[NumberPolygons3D] = new Polygon3D(new double[]{2, 2, 2, 2}, new double[]{0, 2, 2, 0},  new double[]{0, 0, 3, 3}, Color.gray);*/
		for(int i = -10; i < 10; i++)
			for(int j = -10; j < 10; j++)
				Polygons3D[NumberPolygons3D] = new Polygon3D(new double[]{i, i, i + 1, i + 1}, new double[]{j, j + 1, j + 1, j},  new double[]{0, 0, 0, 	0}, Color.green	);
		
		globalLight = new Light(new double[] {10,10,10}, new double[] {0,0,0});
	}
